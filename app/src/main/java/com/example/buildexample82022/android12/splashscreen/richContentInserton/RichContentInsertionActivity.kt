package com.example.buildexample82022.android12.splashscreen.richContentInserton
...
class RichContentInsertionActivity:AppCompatActivity() {
    lateinit var textInputEditText: TextInputEditText

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_rich_content_insertion)
