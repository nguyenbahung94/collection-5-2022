package com.example.buildexample82022.android13.notification_runtime_permisson
...
class NotificationRuntimePermissionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.notification_runtime_permission)
