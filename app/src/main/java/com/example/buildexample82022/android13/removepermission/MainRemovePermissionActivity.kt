package com.example.buildexample82022.android13.removepermission
...
class MainRemovePermissionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_remove_permission)
    ...
    private fun initializeUI() {
        buttonRequestPermissions = findViewById(R.id.buttonrequestpermission)
