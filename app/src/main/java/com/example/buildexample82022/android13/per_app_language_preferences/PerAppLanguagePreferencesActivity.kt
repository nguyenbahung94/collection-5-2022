package com.example.buildexample82022.android13.per_app_language_preferences
...
class PerAppLanguagePreferencesActivity:AppCompatActivity() {

    private var localeManager: LocaleManager? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_per_app_language_preferences)
